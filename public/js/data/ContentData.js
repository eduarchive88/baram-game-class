...
const GameData = {
    ...
    monsters: {
        ...
        'm_004_rabbit': { name: '산토끼', hp: 35, atk: 6, exp: 15, gold: 8, sprite: 'monster_rabbit' },
        'm_005_bee': { name: '말벌', hp: 50, atk: 18, exp: 35, gold: 12, sprite: 'monster_wasp' },
        'm_001b_slime_blue': { name: '파랑 슬라임', hp: 75, atk: 15, exp: 45, gold: 20 },
        'm_003b_squirrel_strong': { name: '힘센 다람쥐', hp: 100, atk: 22, exp: 65, gold: 35 },
        'm_006_crow': { name: '까마귀', hp: 85, atk: 25, exp: 60, gold: 25, sprite: 'monster_crow' },
        'm_007_caterpillar': { name: '거대 송충이', hp: 120, atk: 12, exp: 55, gold: 15 },
        'm_008_fox': { name: '여우', hp: 160, atk: 35, exp: 110, gold: 50, sprite: 'monster_fox' },
